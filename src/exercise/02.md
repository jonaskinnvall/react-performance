...
- When React.useMemo can be reeally useful to stop expensive code and
  calculations from running on each re-render and instead only run when thier
  values actually change
- I learned how to use the performance tab in the Chrome devtools to profile the
  performance of the app and get insight into what is actually taking a long
  time to execute
- I also got insight into how web workers can be used to further speed up the
  performance of our app by letting us put our expensive code into a seperate
  thread to free up our main thread to display what it needs to the user more
  quickly
